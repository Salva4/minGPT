...
class CausalSelfAttention(nn.Module):
    def __init__(self, d_model, nhead, resid_pdrop, attn_pdrop, block_size):
        super().__init__()
...
class Block(nn.Module):
    def __init__(self, d_model, nhead, resid_pdrop, attn_pdrop, block_size):
        ...
        self.attn = CausalSelfAttention(
            d_model, nhead, resid_pdrop, attn_pdrop, block_size
        )
...
class GPT(nn.Module):
    def __init__(
            self, vocab_size, block_size, d_model, nhead, num_layers, 
        ...
        self.transformer = nn.ModuleList(
            [
                Block(d_model, nhead, resid_pdrop, attn_pdrop, block_size) 
